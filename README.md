# (Unofficial) eBay API client (PHP) - Sell / Finances
...
```shell
composer require bricre/ebay-api-sell-finances
```
...
Starting from version 1.9.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/sell/finances/v1/',
        'headers'=>[
